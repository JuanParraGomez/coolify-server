...
export default function FiltersPanel({ regions, onFilterChange }: FiltersPanelProps) {
  ...
  return (
    ...
    >
      <h3 style={{ margin: '0 0 1rem', color: '#1e293b', fontSize: '0.95rem', fontWeight: 600 }}>Filtros</h3>
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        <div style={{ flex: '1', minWidth: '160px' }}>
          <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: '#64748b', marginBottom: '0.375rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
            Región
          </label>
          <select
